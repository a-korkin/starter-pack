...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20211204151418_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("src.Domain.Entities.Admin.Claim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("src.Domain.Entities.Admin.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("src.Domain.Entities.Admin.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnName("id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("src.Domain.Entities.Common.Entity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("src.Domain.Entities.Common.EntityType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("src.Domain.Entities.Admin.Claim", b =>
                {
                    b.HasOne("src.Domain.Entities.Admin.Role", "Role")
                        .WithMany("Claims")
                    ...
                    b.HasOne("src.Domain.Entities.Common.EntityType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("src.Domain.Entities.Admin.User", b =>
                {
                    b.HasOne("src.Domain.Entities.Common.Entity", null)
                        .WithMany()
                        .HasForeignKey("Id")
